...
public class PasswordAuth : HostAuth
{
/// <summary>
...
/// </summary>
    ...
    /// <summary>
    /// Sets the password for a server. Should only run when a host is starting the server.
    /// </summary>
    /// <param name="password"></param>
    public void SetPassword(string password)
    {
        //Clients should never be able to change the password
        if (InstanceFinder.NetworkManager.IsClientStarted)
            return;

        //The password should not be changed while the server is already running
